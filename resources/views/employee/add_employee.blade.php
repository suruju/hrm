                        ...
                        <div class="card rounded">
                            <div class="card-body">
                                ...
                                <form id="validateForm" class="forms-sample" method="POST"
                                    action="{{ route('store.employee') }}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-check mb-3">
                                        <img id="showImage" class="wd-80 rounded-circle" src="" alt="">
                                    </div>
                                    <div class="mb-3">
                                        <input type="checkbox" id="allow_login" value="1" name="allow_login"
                                            class="form-check-input" id="allow_login">
